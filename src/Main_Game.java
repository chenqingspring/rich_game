...
public class Main_Game {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (s.equals("rich")) {
            ...
            String playerNumbers = readString6();

            int[] intarry = new int[playerNumbers.length()];
            for (int i = 0; i < playerNumbers.length(); i++) {
                intarry[i] = Integer.parseInt(String.valueOf(playerNumbers.charAt(i)));
            }
            ...
            //player1.diaplayStatus();
            while (true) {
                if (player1.is_Selected == true) {
                    map.playerTurn(player1);
                }
                if (player2.is_Selected == true) {
                    map.playerTurn(player2);
                }
                if (player3.is_Selected == true) {
                    map.playerTurn(player3);
                }
                if (player4.is_Selected == true) {
                    map.playerTurn(player4);
                }
            }
